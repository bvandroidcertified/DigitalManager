...
import com.bvlabs.digitalmanager.tableview.holder.CellBtnViewHolder;
import com.bvlabs.digitalmanager.tableview.holder.CellFabViewHolder;
import com.bvlabs.digitalmanager.tableview.holder.CellViewHolder;
import com.bvlabs.digitalmanager.tableview.holder.ColumnHeaderViewHolder;
import com.bvlabs.digitalmanager.tableview.holder.RowHeaderViewHolder;
...
public class TableViewAdapter extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final int GENDER_CELL_TYPE = 8;
    private static final int SAVE_BUTTON_CELL_TYPE = 2;
    private static final int SAVE_BUTTON_ACTION_CELL_TYPE = 6;
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case SAVE_BUTTON_CELL_TYPE:
                layout = mInflater.inflate(R.layout.table_view_cell_button_layout, parent, false);
                return new CellBtnViewHolder(layout);
            case SAVE_BUTTON_ACTION_CELL_TYPE:
                layout = mInflater.inflate(R.layout.table_view_cell_action_layout, parent, false);
                return new CellFabViewHolder(layout);
            default:
    ...
    public void onBindCellViewHolder(AbstractViewHolder holder, Object cellItemModel, int
        ...
        switch (holder.getItemViewType()) {
            ...
            case SAVE_BUTTON_CELL_TYPE:
                CellBtnViewHolder btnViewHolder = (CellBtnViewHolder) holder;
                btnViewHolder.setData(cell);
                break;
            case SAVE_BUTTON_ACTION_CELL_TYPE:
                CellFabViewHolder btnFabViewHolder = (CellFabViewHolder) holder;
                btnFabViewHolder.setMdata(cell);
                break;
            default:
    ...
    public int getCellItemViewType(int column) {
        ...
        // type of CellViewHolder on "onCreateCellViewHolder"
        switch (column) {
            case TableViewModel.CELL_BTN_COLUMN_INDEX:
                return SAVE_BUTTON_CELL_TYPE;
            case TableViewModel.CELL_BTN_ACTION_COLUMN_INDEX:
                return SAVE_BUTTON_ACTION_CELL_TYPE;
            default:
                // Default view type
                return 0;
        }
